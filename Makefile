...
SSLPatch_CVE-2014-1266_FILES = Tweak.x minimal.c ssl_hooks.c sslAesGcmCipher.c ./cc/cc.c ./cc/ccaes_gcm_mode.c ./cc/ccaes_gcm.c
SSLPatch_CVE-2014-1266_CFLAGS = -fvisibility=hidden -D__SSLPATCH_NO_ASM__ -I. -Icc/ -Icc/vng -Wno-unused-function
